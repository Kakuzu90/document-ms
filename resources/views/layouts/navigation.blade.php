        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-2">
                ...
                <x-dropdown align="right" width="80">
                    <x-slot name="trigger">
                        <button class="relative p-2 text-surface-400 hover:text-surface-600 focus:outline-none transition-colors cursor-pointer">
                    ...
                    <x-slot name="content">
                        ...
                        <div class="border-t border-surface-100 px-4 py-2 text-center bg-surface-50/50">
                            <a href="{{ url('/notifications') }}" class="text-xs font-semibold text-primary-600 hover:text-primary-700 transition-colors">See all</a>
                        </div>
                    </x-slot>
                </x-dropdown>
